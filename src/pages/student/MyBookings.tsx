...
export default function MyBookings() {
  ...
  const canCancel = (booking: MealBooking) => {
    return (
      !isBefore(new Date(booking.date), startOfDay(new Date())) &&
        ...
        {loading ? (
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            {filteredBookings.map((booking) => (
              <Card
                key={booking.id}
                className="card-shadow hover:card-shadow-lg transition-all animate-fade-in"
              >
                <CardHeader className="pb-3">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <div
                        className={`flex h-10 w-10 items-center justify-center rounded-lg text-white ${getMealGradient(
                          booking.meal_type
                        )}`}
                      >
                      ...
                      <AlertDialog>
                        ...
                        <AlertDialogContent>
                          <AlertDialogHeader>
                            ...
                            <AlertDialogDescription>
                              Are you sure you want to cancel your {booking.meal_type} booking
                              for {format(new Date(booking.date), 'MMMM d, yyyy')}? This action
                              cannot be undone.
                            </AlertDialogDescription>
                          </AlertDialogHeader>
                          <AlertDialogFooter>
